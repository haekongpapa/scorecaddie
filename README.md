...
개방형 회원가입(이메일/비밀번호 + 구글/네이버/카카오 소셜 로그인), 공공데이터포털 연동 골프장 목록, 기상청 날씨 연동, 2-Step 스코어 등록, 스코어 조회, 관리자용 골프장 관리/회원 관리까지 총 8가지 핵심 기능으로 구성됩니다. 골프장은 9홀 단위 "루프"로 구성해 18/27/36홀 등 다양한 코스 구조를 지원합니다.
