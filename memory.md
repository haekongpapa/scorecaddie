...
- **화면 단위 밖에서 남은 작업(우선순위 순서 없음, 사용자 지정 대기)**:
  1. ~~`app/README.md`·루트 `README.md`가 구버전 기준으로 멈춰 있음~~ — 루트 `README.md`는 121번 항목(2026-07-29)에서 개요/분석설계/구현/배포 4단계 요약 + 산출물 표로 전면 재작성 완료. `app/README.md`는 여전히 미착수 상태로 남아있음(다음 후보).
